...
CREATE TABLE IF NOT EXISTS preverb_family (
  preverb_family_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  family_code VARCHAR(128) NOT NULL UNIQUE, -- e.g. "obaru"
  notes TEXT
);
