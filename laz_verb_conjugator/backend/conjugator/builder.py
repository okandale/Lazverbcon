...
class ConjugatorBuilder:
    ...
    def set_tense(self, tense):
        ...
        if self.moods & (Mood.OPTATIVE | Mood.IMPERATIVE | Mood.NEGATIVE_IMPERATIVE):
            raise ConjugatorError("You cannot set a tense while the optative/imperative/negative imperative mood is set.")
    ...
    def add_mood(self, mood):
        ...
        if mood == Mood.IMPERATIVE and Mood.NEGATIVE_IMPERATIVE in self.moods or mood == Mood.NEGATIVE_IMPERATIVE and Mood.IMPERATIVE in self.moods:
            raise ConjugatorError(
    ...
    def set_aspect(self, aspect):
        if self.aspect is not None:
            raise ConjugatorError(
                "The aspect has already been set."
            )
