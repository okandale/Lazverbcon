...
def get_preverbs_rules(mode):
    if mode in ['ivd_future', 'ivd_past', 'ivd_pastpro']:
        return {
            ('gelo', 'ge', 'e', 'cel', 'ce', 'do', 'ye', 'me', 'mola', 'mo', 'oǩo', 'ǩoǩo'): {
                'S1_Singular': 'm',
                'S2_Singular': 'g',
                'S3_Singular': '',
                'S1_Plural': 'm',
        ...
        return {
            ('gelo', 'ge', 'e', 'cel', 'ce', 'dolo', 'do', 'oxo', 'me','gol', 'go', 'oǩo', 'gama', 'mola', 'ye', 'mo', 'ǩoǩo'): {
                'S1_Singular': 'v',
                'S2_Singular': '',
                'S3_Singular': '',
                'S1_Plural': 'v',
        ...
        return {
            ('gelo', 'ge', 'e', 'cel', 'ce', 'dolo', 'do', 'oxo', 'me', 'gol', 'go', 'oǩo', 'gama', 'mo', 'ye', 'cele', 'mola', 'mo', 'ǩoǩo'): {
                'S1_Singular': 'v',
                'S2_Singular': '',
                'S3_Singular': '',
                'S1_Plural': 'v',
        ...
        return {
            ('gelo', 'ge', 'e', 'cel', 'ce', 'dolo', 'do', 'oxo', 'me', 'gol', 'go', 'oǩo', 'gama', 'mola', 'ye', 'gela', 'ela', 'ceǩo', 'eǩo', 'ama', 'mo', 'ǩoǩo'): {
                'S1_Singular': 'v',
                'S2_Singular': '',
                'S3_Singular': '',
                'S1_Plural': 'v',
        ...
        return {
            ('gelo', 'ge', 'e', 'ce', 'dolo', 'do', 'oxo', 'me', 'gol', 'go', 'oǩo', 'gama', 'mo', 'ye', 'mola', 'mo', 'ǩoǩo'): {
                'S1_Singular': 'v',
                'S2_Singular': '',
                'S3_Singular': '',
                'S1_Plural': 'v',
